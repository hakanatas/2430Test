...
public class sixSpecPoses {
    ...
    public static final Pose startPose = new Pose(7.3285, 65.83, 180);
    public static final Pose preloadPose = new Pose(subX + 1, 65.83, 180);

    public static final Pose sixSpecDropOffControl = new Pose(21.15,58.725,180);
   public static final Pose sixSpecDropOffEnd = new Pose(13.5,33.3,225);

    // Combined Push Pathchain

    // pre push
    public static final Pose spline1Control = new Pose(47.025, 44.1, 225);
